...
/**
  ...
  * \param[out]  pChange_rights    Pointer to change rights structure of the commands AC and host encryption flag
...
/**
  ...
  * \param[in]   idle_bus_time_to_standby  For standby, period of time without
  *                  any command processing and with I2C bus idle until the chip
  *                  enters standby mode. Coded in 50ms steps, starting from
  *                  50ms as floor value (0: 50ms, 1: 100ms, ..., 31: 1600ms)
