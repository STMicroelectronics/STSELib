 ...
 * \details 	This API encrypt payload in AES ECB mode using the specified key from STSE symmetric key table
 ...
 * \details 	This API decrypt payload in AES ECB mode using the specified key from STSE symmetric key table
 * \param[in] 	pSTSE 			Pointer to STSE Handler
 * \param[in] 	slot_number 		Key slot in symmetric key table to be used
 * \param[in] 	message_length 		Length of the message
 ...
 * \details 	This API Encrypt payload in AES CCM* mode using the specified key from STSE symmetric key table
 * \param[in] 	pSTSE 							Pointer to STSE Handler
 * \param[in] 	slot_number 					Key slot in symmetric key table to be used
 ...
 * \details 	This service start chunk encryption in AES CCM* mode using the specified key from STSE symmetric key table
 * \param[in] 	pSTSE 							Pointer to STSE Handler
 * \param[in] 	slot_number 					Key slot in symmetric key table to be used
 ...
 * \details 	This API Decrypt payload in AES CCM* mode using the specified key from STSE symmetric key table
 * \param[in] 	pSTSE 							Pointer to STSE Handler
 * \param[in] 	slot_number 					Key slot in symmetric key table to be used
 * \param[in] 	authentication_tag_length 		Expected length for the authentication tag
 * \param[in]	pNonce							Buffer containing the nonce
 ...
 * \details 	This service start chunk decryption in AES CCM* mode using the specified key from STSE symmetric key table
 * \param[in] 	pSTSE 							Pointer to STSE Handler
 * \param[in] 	slot_number 					Key slot in symmetric key table to be used
 * \param[in]	Nonce_length					Nonce buffer length in bytes
 * \param[in]	pNonce							Nonce buffer
...
/**
 * \brief 		Encrypt payload in AES CCM mode
 * \details 	This API Encrypt payload in AES GCM mode using the specified key from STSE symmetric key table
 * \param[in] 	pSTSE 						Pointer to STSE Handler
 * \param[in] 	slot_number 				Key slot in symmetric key table to be used
 * \param[in] 	authentication_tag_length 	Expected length for the authentication tag
 ...
 * \details 	This service start chunk encryption in AES GCM mode using the specified key from STSE symmetric key table
 * \param[in] 	pSTSE 							Pointer to STSE Handler
 * \param[in] 	slot_number 					Key slot in symmetric key table to be used
 * \param[in]	IV_length						IV buffer length in bytes
 * \param[in]	pIV								IV buffer
 ...
 * \details 	This API Decrypt payload in AES GCM mode using the specified key from STSE symmetric key table
 * \param[in] 	pSTSE 						Pointer to STSE Handler
 * \param[in] 	slot_number 				Key slot in symmetric key table to be used
 * \param[in] 	authentication_tag_length 	Expected length for the authentication tag
 * \param[in]	IV_length					IV buffer length in bytes
 ...
 * \details 	This service start chunk decryption in AES GCM mode using the specified key from STSE symmetric key table
 * \param[in] 	pSTSE 							Pointer to STSE Handler
 * \param[in] 	slot_number 					Key slot in symmetric key table to be used
 * \param[in]	IV_length						IV buffer length in bytes
 * \param[in]	pIV								IV buffer
