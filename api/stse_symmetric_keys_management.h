...
/** \defgroup   stse_api_symmetric_key_mngt   STSE Symmetric key management
  ...
  *              symmetric key management on target STMicroelectronics Secure
  *              element device.
  *  @{
  */
...
/**
  ...
  * \details   Get the information of one slot in symmetric key table
  * \param[in]   pSTSE           Pointer to STSE Handler
...
/**
  ...
  * \details   Get the information of all slot of symmetric key table
  * \param[in]   pSTSE             Pointer to STSE Handler
