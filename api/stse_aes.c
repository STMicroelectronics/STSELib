  ...
  PLAT_UI8 counter_presence, PLAT_UI32 *pCounter)
{
  ...
  return stsafea_aes_ccm_encrypt(
           ...
           pNonce,
           authentication_tag_length == 0 ? 0 : associated_data_length,
           authentication_tag_length == 0 ? NULL : pAssociated_data,
           message_length,
           message_length == 0 ? NULL : pPlaintext_message,
           pEncrypted_message,
  ...
  PLAT_UI8 *pAuthentication_tag)
{
  ...
  return stsafea_aes_gcm_encrypt(
           ...
           associated_data_length == 0 ? NULL : pAssociated_data,
           message_length,
           pPlaintext_message,
           pEncrypted_message,
           pAuthentication_tag);
