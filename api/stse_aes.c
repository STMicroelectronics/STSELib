				       ...
				       PLAT_UI8 *pEncrypted_message)
{
	...
	return stsafea_aes_ecb_encrypt(pSTSE, slot_number, message_length, pPlaintext_message,
				       pEncrypted_message);
}
				       ...
				       PLAT_UI8 *pPlaintext_message)
{
	...
	return stsafea_aes_ecb_decrypt(pSTSE, slot_number, message_length, pEncrypted_message,
				       pPlaintext_message);
}
				       ...
				       PLAT_UI8 *pCounter_presence, PLAT_UI32 *pCounter)
{
	...
	return stsafea_aes_ccm_encrypt(pSTSE, slot_number, authentication_tag_length, pNonce,
				       associated_data_length, pAssociated_data, message_length,
				       pPlaintext_message, pEncrypted_message,
				       pEncrypted_authentication_tag, pCounter_presence, pCounter);
}
			   ...
			   PLAT_UI8 *pCounter_presence, PLAT_UI32 *pCounter)
{
	...
	return stsafea_aes_ccm_encrypt_start(pSTSE, slot_number, Nonce_length, pNonce,
					     total_associated_data_length, total_message_length,
					     associated_data_chunk_length, pAssociated_data_chunk,
					     message_chunk_length, pPlaintext_message_chunk,
					     pEncrypted_message_chunk, pCounter_presence, pCounter);
}

stse_ReturnCode_t
stse_aes_ccm_encrypt_process(stse_Handler_t *pSTSE, PLAT_UI16 associated_data_chunk_length,
			     PLAT_UI8 *pAssociated_data_chunk, PLAT_UI16 message_chunk_length,
			     PLAT_UI8 *pPlaintext_message_chunk, PLAT_UI8 *pEncrypted_message_chunk)
{
	if (pSTSE == NULL) {
	...
	return stsafea_aes_ccm_encrypt_process(pSTSE, associated_data_chunk_length,
				       ...
				       PLAT_UI8 *pVerification_result, PLAT_UI8 *pPlaintext_message)
{
	...
	return stsafea_aes_ccm_decrypt(pSTSE, slot_number, authentication_tag_length, pNonce,
				       associated_data_length, pAssociated_data, message_length,
				       pEncrypted_message, pEncrypted_authentication_tag,
				       pVerification_result, pPlaintext_message);
}
				       ...
				       PLAT_UI8 *pAuthentication_tag)
{
	...
	return stsafea_aes_gcm_encrypt(pSTSE, slot_number, authentication_tag_length, IV_length,
				       pIV, associated_data_length, pAssociated_data,
				       message_length, pPlaintext_message, pEncrypted_message,
				       pAuthentication_tag);
}
			   ...
			   PLAT_UI8 *pPlaintext_message_chunk)
{
	...
	return stsafea_aes_ccm_decrypt_start(
		pSTSE, slot_number, Nonce_length, pNonce, total_associated_data_length,
		total_ciphertext_length, associated_data_chunk_length, pAssociated_data_chunk,
		message_chunk_length, pEncrypted_message_chunk, pPlaintext_message_chunk);
}

stse_ReturnCode_t
stse_aes_ccm_decrypt_process(stse_Handler_t *pSTSE, PLAT_UI16 associated_data_chunk_length,
			     PLAT_UI8 *pAssociated_data_chunk, PLAT_UI16 message_chunk_length,
			     PLAT_UI8 *pEncrypted_message_chunk, PLAT_UI8 *pPlaintext_message_chunk)
{
	...
	return stsafea_aes_ccm_decrypt_process(pSTSE, associated_data_chunk_length,
					       pAssociated_data_chunk, message_chunk_length,
			   ...
			   PLAT_UI8 *pPlaintext_message_chunk, PLAT_UI8 *pEncrypted_message_chunk)
{
	...
	return stsafea_aes_gcm_encrypt_start(pSTSE, slot_number, IV_length, pIV,
					     associated_data_chunk_length, pAssociated_data_chunk,
					     message_chunk_length, pPlaintext_message_chunk,
...
stse_ReturnCode_t
stse_aes_gcm_encrypt_process(stse_Handler_t *pSTSE, PLAT_UI16 associated_data_chunk_length,
			     PLAT_UI8 *pAssociated_data_chunk, PLAT_UI16 message_chunk_length,
			     PLAT_UI8 *pPlaintext_message_chunk, PLAT_UI8 *pEncrypted_message_chunk)
{
	if (pSTSE == NULL) {
			    ...
			    PLAT_UI8 *pAuthentication_tag)
{
	...
	return stsafea_aes_gcm_encrypt_finish(pSTSE, authentication_tag_length,
					      associated_data_chunk_length, pAssociated_data_chunk,
					      message_chunk_length, pPlaintext_message_chunk,
					      pEncrypted_message_chunk, pAuthentication_tag);
}
				       ...
				       PLAT_UI8 *pVerification_result, PLAT_UI8 *pPlaintext_message)
{
	...
	return stsafea_aes_gcm_decrypt(pSTSE, slot_number, authentication_tag_length, IV_length,
				       pIV, associated_data_length, pAssociated_data,
				       message_length, pEncrypted_message, pAuthentication_tag,
				       pVerification_result, pPlaintext_message);
}
			   ...
			   PLAT_UI8 *pEncrypted_message_chunk, PLAT_UI8 *pPlaintext_message_chunk)
{
	...
	return stsafea_aes_gcm_decrypt_start(pSTSE, slot_number, IV_length, pIV,
					     associated_data_chunk_length, pAssociated_data_chunk,
					     message_chunk_length, pEncrypted_message_chunk,
					     pPlaintext_message_chunk);
}

stse_ReturnCode_t
stse_aes_gcm_decrypt_process(stse_Handler_t *pSTSE, PLAT_UI16 associated_data_chunk_length,
			     PLAT_UI8 *pAssociated_data_chunk, PLAT_UI16 message_chunk_length,
			     PLAT_UI8 *pEncrypted_message_chunk, PLAT_UI8 *pPlaintext_message_chunk)
{
	if (pSTSE == NULL) {
