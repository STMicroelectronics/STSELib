 ...
 */
typedef struct {
	stse_ReturnCode_t (*BusRecvStart)(PLAT_UI8,  /* busID */
					  PLAT_UI8,  /* devAddr */
					  PLAT_UI16, /* speed */
					  PLAT_UI16  /* pFrameLength */
	); /*\var stse_io_t::BusRecvStart Bus Receive start function callback */
	stse_ReturnCode_t (*BusRecvContinue)(PLAT_UI8,   /*busID*/
					     PLAT_UI8,   /*devAddr*/
					     PLAT_UI16,  /*speed*/
					     PLAT_UI8 *, /*pElement*/
	    ...
	    */
	stse_ReturnCode_t (*BusRecvStop)(PLAT_UI8,   /*busID*/
					 PLAT_UI8,   /*devAddr*/
					 PLAT_UI16,  /*speed*/
					 PLAT_UI8 *, /*pElement*/
					 PLAT_UI16   /*element_size*/
	); /*<\var stse_io_t::BusRecvStop Bus Receive stop function callback */
	stse_ReturnCode_t (*BusSendStart)(PLAT_UI8,  /* busID */
					  PLAT_UI8,  /* devAddr */
					  PLAT_UI16, /* speed */
					  PLAT_UI16  /* FrameLength */
	); /*<\var stse_io_t::BusSendStart Bus Send start function callback */
	stse_ReturnCode_t (*BusSendContinue)(PLAT_UI8,   /*busID*/
					     PLAT_UI8,   /*devAddr*/
					     PLAT_UI16,  /*speed*/
					     PLAT_UI8 *, /*pElement*/
					     PLAT_UI16   /*element_size*/
	); /*<\var stse_io_t::BusSendContinue Bus Send continue function callback */
	stse_ReturnCode_t (*BusSendStop)(PLAT_UI8,   /*busID*/
					 PLAT_UI8,   /*devAddr*/
					 PLAT_UI16,  /*speed*/
					 PLAT_UI8 *, /*pElement*/
					 PLAT_UI16   /*element_size*/
	); /*<\var stse_io_t::BusSendStop Bus Send stop function callback */
	stse_ReturnCode_t (*IOLineGet)(PLAT_UI8); /*<\var stse_io_t::IOLineGet Get Bus I/O Line
						     state function callback */
	stse_ReturnCode_t (*BusWake)(
		PLAT_UI8, PLAT_UI8,
		PLAT_UI16); /*<\var stse_io_t::BusWake Bus wake function callback */
	stse_ReturnCode_t (*BusRecovery)(PLAT_UI8, PLAT_UI8); /*<\var stse_io_t::BusRecovery Bus
								 recovery function callback */
	stse_ReturnCode_t (*PowerLineOff)(PLAT_UI8,
					  PLAT_UI8); /*<\var stse_io_t::PowerLineOff Bus power line
							off function callback */
	stse_ReturnCode_t (*PowerLineOn)(PLAT_UI8, PLAT_UI8); /*<\var stse_io_t::PowerLineOn Bus
								 power line on function callback */
 ...
 * \brief STSE Handler
 * 		  This handler stores all the context and working data related
 * to a specific STSE target. \n Pointer to a specific stsafe_Handler is the
 * main parameters of all STSE middleware API functions. \n A specific STSE
 * target Handler must be initialized using the "stsafe_init" API function
 */
 ...
 * \details 		This core function initialise the handler to default
 * value \param[in] 		pStseHandler 	Pointer to STSE handler \return
 * \ref stse_ReturnCode_t : STSE_OK on success ; error code otherwise
 */
