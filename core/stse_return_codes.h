...
enum stse_ReturnCode_t
{
  ...
  STSE_UNEXPECTED_ERROR = 0x05,               /*!< STSE Encounter an unexpected error */
  ...
  STSE_ENTRY_NOT_FOUND = 0x10,                /*!< STSE Requested resource not found */
  ...
  STSE_SERVICE_INVALID_FRAME,
  STSE_SERVICE_INCOMPATIBLE_DEVICE_TYPE,
