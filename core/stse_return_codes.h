...
enum stse_ReturnCode_t {
	...
	STSE_PLATFORM_SERVICES_INIT_ERROR =
		0x0101,                  /*!< STSE Host platform service initialization error */
	STSE_PLATFORM_CRYPTO_INIT_ERROR, /*!< STSE Host criptographic service
					    initialization error */
	STSE_PLATFORM_INVALID_PARAMETER, /*!< Error detected on the STSE HW Bus */
	STSE_PLATFORM_BUS_ERR,
	STSE_PLATFORM_BUFFER_ERR,           /*!< STSE Host platform Communication bus buffer
					       overflow */
	STSE_PLATFORM_BUS_ARBITRATION_LOST, /*!< STSE Host platform Communication bus
					       Arbitration Lost */
	STSE_PLATFORM_BUS_RECEIVE_TIMEOUT,  /*!< STSE Host platform Communication bus
					       Receive Timeout */
	STSE_PLATFORM_BUS_ACK_ERROR,        /*!< STSE Host platform Communication bus Ack
					       Timout */
	...
	STSE_CORE_FRAME_RMAC_ERROR, /*!< STSE communication authenticity/integrity
				       error */
	...
	STSE_SERVICE_HANDLER_NOT_INITIALISED,    /*!< STSE is not initialized please run
						    stsafe_init function first */
	...
	STSE_API_HANDLER_NOT_INITIALISED, /*!< STSE is not initialized please run
					     stsafe_init function first */
	...
	STSE_CERT_HANDLER_NOT_INITIALISED,    /*!< STSE is not initialized please run
						 stsafe_init function first */
