...
typedef enum stse_zone_ac_t
{
  ...
  STSE_AC_AUTH_AND_HOST = 6, /*!< Zone/counter access granted on true Authentic
                              entity status (verify entity signature)
                              + Host C-MAC validation */
...
#define STSE_BRAINPOOL_P_512_EPHEMERAL_PUBLIC_KEY_SIZE 2\
  + STSE_BRAINPOOL_P_512_ID_SIZE + STSE_BRAINPOOL_P_512_PUBLIC_KEY_SIZE
...
#endif /* defined(STSE_CONF_ECC_NIST_P_256) || defined(STSE_CONF_ECC_NIST_P_384) || */
