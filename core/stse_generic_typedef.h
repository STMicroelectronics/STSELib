...
#define STSE_NIST_P_256_PUBLIC_KEY_SIZE 				STSAFE_NIST_BRAINPOOL_POINT_REPRESENTATION_ID_SIZE \
													  + STSE_NIST_P_256_X_COORDINATE_LENGTH_SIZE \
													  + STSE_NIST_P_256_X_COORDINATE_VALUE_SIZE \
													  + STSE_NIST_P_256_Y_COORDINATE_LENGTH_SIZE \
													  + STSE_NIST_P_256_Y_COORDINATE_VALUE_SIZE
#define STSE_NIST_P_256_PRIVATE_KEY_SIZE				32U
#define STSE_NIST_P_256_SHARED_SECRET_SIZE  			STSE_NIST_P_256_X_COORDINATE_LENGTH_SIZE \
														+ STSE_NIST_P_256_X_COORDINATE_VALUE_SIZE
...
#define STSE_NIST_P_256_SIGNATURE_SIZE 				STSE_NIST_P_256_SIGNATURE_R_LENGTH_SIZE \
														+ STSE_NIST_P_256_SIGNATURE_S_LENGTH_SIZE \
														+ STSE_NIST_P_256_SIGNATURE_S_VALUE_SIZE \
														+ STSE_NIST_P_256_SIGNATURE_R_VALUE_SIZE
...
#define STSE_NIST_P_384_ID_LENGTH 					{0x00,0x05}
#define STSE_NIST_P_384_ID_VALUE_SIZE				5U
#define STSE_NIST_P_384_ID_VALUE 					{0x2B,0x81,0x04,0x00,0x22}
#define STSE_NIST_P_384_ID_SIZE 						STSE_NIST_P_384_ID_LENGTH_SIZE \
...
#define STSE_NIST_P_384_PUBLIC_KEY_SIZE 				STSAFE_NIST_BRAINPOOL_POINT_REPRESENTATION_ID_SIZE \
												  	    + STSE_NIST_P_384_X_COORDINATE_LENGTH_SIZE \
													    + STSE_NIST_P_384_Y_COORDINATE_LENGTH_SIZE \
...
#define STSE_NIST_P_384_EPHEMERAL_PUBLIC_KEY_SIZE  	STSE_NIST_P_384_ID_SIZE \
...
#define STSE_NIST_P_384_SIGNATURE_SIZE 				STSE_NIST_P_384_SIGNATURE_R_LENGTH_SIZE \
														+ STSE_NIST_P_384_SIGNATURE_S_LENGTH_SIZE \
														+ STSE_NIST_P_384_SIGNATURE_S_VALUE_SIZE \
														+ STSE_NIST_P_384_SIGNATURE_R_VALUE_SIZE
#define STSE_NIST_P_384_SHARED_SECRET_LENGTH_SIZE 	2U
#define STSE_NIST_P_384_SHARED_SECRET_SIZE 			STSE_NIST_P_384_SHARED_SECRET_LENGTH_SIZE \
														+ STSE_NIST_P_384_X_COORDINATE_VALUE_SIZE
...
#define STSE_NIST_P_521_ID_LENGTH 					{0x00,0x05}
#define STSE_NIST_P_521_ID_VALUE_SIZE				5U
#define STSE_NIST_P_521_ID_VALUE 					{0x2B,0x81,0x04,0x00,0x23}
#define STSE_NIST_P_521_ID_SIZE 						STSE_NIST_P_521_ID_LENGTH_SIZE \
...
#define STSE_NIST_P_521_PUBLIC_KEY_SIZE 				STSAFE_NIST_BRAINPOOL_POINT_REPRESENTATION_ID_SIZE \
												 		+ STSE_NIST_P_521_X_COORDINATE_LENGTH_SIZE \
														+ STSE_NIST_P_521_Y_COORDINATE_LENGTH_SIZE \
...
#define STSE_NIST_P_521_EPHEMERAL_PUBLIC_KEY_SIZE  	2 \
														+ STSE_NIST_P_521_ID_SIZE \
														+ STSE_NIST_P_521_PUBLIC_KEY_SIZE
#define STSE_NIST_P_521_SHARED_SECRET_LENGTH_SIZE 	2U
#define STSE_NIST_P_521_SHARED_SECRET_SIZE 			STSE_NIST_P_521_SHARED_SECRET_LENGTH_SIZE \
														+ STSE_NIST_P_521_X_COORDINATE_VALUE_SIZE
...
#define STSE_NIST_P_521_SIGNATURE_SIZE 				STSE_NIST_P_521_SIGNATURE_R_LENGTH_SIZE \
														+ STSE_NIST_P_521_SIGNATURE_S_LENGTH_SIZE \
														+ STSE_NIST_P_521_SIGNATURE_S_VALUE_SIZE \
														+ STSE_NIST_P_521_SIGNATURE_R_VALUE_SIZE
...
#define STSE_BRAINPOOL_P_256_ID_LENGTH					{0x00,0x09}
#define STSE_BRAINPOOL_P_256_ID_VALUE_SIZE				9U
#define STSE_BRAINPOOL_P_256_ID_VALUE					{0x2B,0x24,0x03,0x03,0x02,0x08,0x01,0x01,0x07}
#define STSE_BRAINPOOL_P_256_ID_SIZE 					STSE_BRAINPOOL_P_256_ID_LENGTH_SIZE \
...
#define STSE_BRAINPOOL_P_256_PUBLIC_KEY_SIZE 			STSAFE_NIST_BRAINPOOL_POINT_REPRESENTATION_ID_SIZE \
													  	    + STSE_BRAINPOOL_P_256_X_COORDINATE_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_256_X_COORDINATE_VALUE_SIZE \
															+ STSE_BRAINPOOL_P_256_Y_COORDINATE_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_256_Y_COORDINATE_VALUE_SIZE
#define STSE_BRAINPOOL_P_256_PRIVATE_KEY_SIZE			32U
#define STSE_BRAINPOOL_P_256_SHARED_SECRET_SIZE  		STSE_BRAINPOOL_P_256_X_COORDINATE_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_256_X_COORDINATE_VALUE_SIZE
#define STSE_BRAINPOOL_P_256_EPHEMERAL_PUBLIC_KEY_SIZE  	STSE_BRAINPOOL_P_256_ID_SIZE \
...
#define STSE_BRAINPOOL_P_256_SIGNATURE_SIZE 				STSE_BRAINPOOL_P_256_SIGNATURE_R_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_256_SIGNATURE_S_LENGTH_SIZE \
...
#define STSE_BRAINPOOL_P_384_ID_LENGTH 					{0x00,0x09}
#define STSE_BRAINPOOL_P_384_ID_VALUE_SIZE				9U
#define STSE_BRAINPOOL_P_384_ID_VALUE 					{0x2B,0x24,0x03,0x03,0x02,0x08,0x01,0x01,0x0B}
#define STSE_BRAINPOOL_P_384_ID_SIZE 					STSE_BRAINPOOL_P_384_ID_LENGTH_SIZE \
...
#define STSE_BRAINPOOL_P_384_PUBLIC_KEY_SIZE 			STSAFE_NIST_BRAINPOOL_POINT_REPRESENTATION_ID_SIZE \
												  	  	  	+ STSE_BRAINPOOL_P_384_X_COORDINATE_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_384_Y_COORDINATE_LENGTH_SIZE \
...
#define STSE_BRAINPOOL_P_384_EPHEMERAL_PUBLIC_KEY_SIZE  	STSE_BRAINPOOL_P_384_ID_SIZE \
...
#define STSE_BRAINPOOL_P_384_SIGNATURE_SIZE 				STSE_BRAINPOOL_P_384_SIGNATURE_R_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_384_SIGNATURE_S_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_384_SIGNATURE_S_VALUE_SIZE \
															+ STSE_BRAINPOOL_P_384_SIGNATURE_R_VALUE_SIZE
#define STSE_BRAINPOOL_P_384_SHARED_SECRET_LENGTH_SIZE 	2U
#define STSE_BRAINPOOL_P_384_SHARED_SECRET_SIZE 			STSE_BRAINPOOL_P_384_SHARED_SECRET_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_384_X_COORDINATE_VALUE_SIZE
...
#define STSE_BRAINPOOL_P_512_ID_LENGTH 					{0x00,0x09}
#define STSE_BRAINPOOL_P_512_ID_VALUE_SIZE				9U
#define STSE_BRAINPOOL_P_512_ID_VALUE 					{0x2B,0x24,0x03,0x03,0x02,0x08,0x01,0x01,0x0D}
#define STSE_BRAINPOOL_P_512_ID_SIZE 					STSE_BRAINPOOL_P_512_ID_LENGTH_SIZE \
...
#define STSE_BRAINPOOL_P_512_PUBLIC_KEY_SIZE 			STSAFE_NIST_BRAINPOOL_POINT_REPRESENTATION_ID_SIZE \
												  	  	    + STSE_BRAINPOOL_P_512_X_COORDINATE_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_512_Y_COORDINATE_LENGTH_SIZE \
...
#define STSE_BRAINPOOL_P_512_EPHEMERAL_PUBLIC_KEY_SIZE  	2 + STSE_BRAINPOOL_P_512_ID_SIZE \
															+ STSE_BRAINPOOL_P_512_PUBLIC_KEY_SIZE
#define STSE_BRAINPOOL_P_512_SHARED_SECRET_LENGTH_SIZE 	2U
#define STSE_BRAINPOOL_P_512_SHARED_SECRET_SIZE 			STSE_BRAINPOOL_P_512_SHARED_SECRET_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_512_X_COORDINATE_VALUE_SIZE
...
#define STSE_BRAINPOOL_P_512_SIGNATURE_SIZE 				STSE_BRAINPOOL_P_512_SIGNATURE_R_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_512_SIGNATURE_S_LENGTH_SIZE \
															+ STSE_BRAINPOOL_P_512_SIGNATURE_S_VALUE_SIZE \
															+ STSE_BRAINPOOL_P_512_SIGNATURE_R_VALUE_SIZE
...
#define STSE_X25519_ID_LENGTH 					{0x00,0x03}
#define STSE_X25519_ID_VALUE_SIZE 				3U
#define STSE_X25519_ID_VALUE 					{0x2B,0x65,0x6E}
#define STSE_X25519_ID_SIZE 						STSE_X25519_ID_LENGTH_SIZE \
													+ STSE_X25519_ID_VALUE_SIZE
#define STSE_X25519_PUBLIC_KEY_LENGTH_SIZE 		2U
#define STSE_X25519_PUBLIC_KEY_VALUE_SIZE 		32U
#define STSE_X25519_PUBLIC_KEY_SIZE				STSE_X25519_PUBLIC_KEY_LENGTH_SIZE \
													+ STSE_X25519_PUBLIC_KEY_VALUE_SIZE
#define STSE_X25519_PRIVATE_KEY_SIZE				32U
#define STSE_X25519_EPHEMERAL_PUBLIC_KEY_SIZE  	STSE_X25519_ID_SIZE \
...
#define STSE_X25519_SIGNATURE_SIZE 				STSE_X25519_SIGNATURE_R_LENGTH_SIZE \
													+ STSE_X25519_SIGNATURE_R_VALUE_SIZE \
													+ STSE_X25519_SIGNATURE_S_LENGTH_SIZE \
													+ STSE_X25519_SIGNATURE_S_VALUE_SIZE
#define STSE_X25519_SHARED_SECRET_LENGTH_SIZE 	2U
#define STSE_X25519_SHARED_SECRET_VALUE_SIZE 	32U
#define STSE_X25519_SHARED_SECRET_SIZE 			STSE_X25519_SHARED_SECRET_LENGTH_SIZE \
...
#define STSE_ED25519_ID_LENGTH 					{0x00,0x03}
#define STSE_ED25519_ID_VALUE_SIZE 				3U
#define STSE_ED25519_ID_VALUE 					{0x2B,0x65,0x70}
#define STSE_ED25519_PUBLIC_KEY_LENGTH_SIZE 		2U
#define STSE_ED25519_PUBLIC_KEY_VALUE_SIZE 		32U
#define STSE_ED25519_PUBLIC_KEY_SIZE				STSE_ED25519_PUBLIC_KEY_LENGTH_SIZE \
													+ STSE_ED25519_PUBLIC_KEY_VALUE_SIZE
#define STSE_ED25519_PRIVATE_KEY_SIZE			64U
#define STSE_ED25519_EPHEMERAL_PUBLIC_KEY_SIZE  	STSE_ED25519_ID_SIZE \
...
#define STSE_ED25519_SIGNATURE_SIZE 				STSE_ED25519_SIGNATURE_R_LENGTH_SIZE \
													+ STSE_ED25519_SIGNATURE_R_VALUE_SIZE \
													+ STSE_ED25519_SIGNATURE_S_LENGTH_SIZE \
...
#define STSE_ED25519_SHARED_SECRET_SIZE 			STSE_ED25519_SHARED_SECRET_LENGTH_SIZE \
