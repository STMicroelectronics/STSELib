							   ...
							   PLAT_UI16 output_keying_material_length)
{
	...
	retval = stse_platform_hmac_sha256_extract(pSalt, salt_length, pInput_keying_material,
	...
	retval = stse_platform_hmac_sha256_expand(pPseudorandom_key, STSAFEA_SHA_256_HASH_SIZE,
						  pInfo, info_length, pOutput_keying_material,
