...
/**
  ...
  * \param[in]  size size (in bytes) of the value field of this INTEGER
  *                  (got from \ref stse_certificate_identify_ASN1_TLV )
  * \retval    0 Success
...
/**
  ...
  * \param[in]  size size (in bytes) of the value field of this BITSTRING
  *                  (got from \ref stse_certificate_identify_ASN1_TLV )
  * \retval    0 Success
...
/** \brief print information about a stse_certificate_t certificate */
