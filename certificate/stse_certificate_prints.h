...
/**
 * \brief  Print the TAG
 * \param[in]	tag tag of ASN.1 TLV  (got from \ref
 * stse_certificate_identify_ASN1_TLV )
 */
 ...
 * \param[in]  *value pointer to the value of a INTEGER (got from \ref
 * stse_certificate_identify_ASN1_TLV ) \param[in]  size size (in bytes) of the
 * value field of this INTEGER (got from \ref stse_certificate_identify_ASN1_TLV
 * ) \retval    0 Success
 ...
 * \param[in]  *value pointer to the value of a BITSTRING (got from \ref
 * stse_certificate_identify_ASN1_TLV ) \param[in]  size size (in bytes) of the
 * value field of this BITSTRING (got from \ref
 * stse_certificate_identify_ASN1_TLV ) \retval    0 Success
 * \retval    -1 Failure. The bitstring excludes some of the LSBits of the LSB,
 ...
 * partial parse function (for printing only)
 */
