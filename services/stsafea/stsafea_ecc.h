 ...
 * \details 	This service formats and send/receive STSAFE-Axxx verify
 * signature command/response
...
/**
 * \brief 		Generate n ECDSA or an EdDSA signature depending on the
 * curve in the private key slot \details 	This service formats and
 * send/receive STSAFE-Axxx generate signature command/response \param[in]
 * pSTSE 					Pointer to STSE Handler
 * \param[in] 	slot_number				Slot to identify used
 * private
 * key \param[in] 	key_type 				Private key type
 * \param[in] 	pMessage 				Message used in
 * signature \param[in] 	message_length 			Message length
