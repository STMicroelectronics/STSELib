...
/**
  * \brief     Query host key information (host key V1)
  * \details   This service format and send query host key information command
  * \param[in]   pSTSE       Pointer to STSE Handler
  * \param[out]  pHostKeySlot    Pointer to the structure to output key information
  * \return \ref stse_ReturnCode_t : STSAFEA_OK on success ; error code otherwise
  */
...
/**
  * \brief     Query host key information (host key V2)
  * \details   This service format and send query host key information command
  * \param[in]   pSTSE       Pointer to STSE Handler
  * \param[out]  pHostKeySlotV2    Pointer to the structure to output key information
  * \return \ref stse_ReturnCode_t : STSAFEA_OK on success ; error code otherwise
  */
