 ...
 */
stse_ReturnCode_t stsafea_frame_transmit(stse_Handle_t *pSTSE,
                                         stse_frame_t *pFrame);
 ...
 * \return 			\ref STSE_OK on success ; \ref stse_ReturnCode_t error code otherwise
 */
stse_ReturnCode_t stsafea_frame_receive(stse_Handle_t *pSTSE,
                                        stse_frame_t *pFrame);
 ...
 * \return 			\ref STSE_OK on success ; \ref stse_ReturnCode_t error code otherwise
 */
stse_ReturnCode_t stsafea_frame_transfer(stse_Handle_t *pSTSE,
                                         stse_frame_t *pCmdFrame,
                                         stse_frame_t *pRspFrame);
