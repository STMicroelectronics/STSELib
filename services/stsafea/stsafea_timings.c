...
const PLAT_UI16 stsafea_cmd_timings[STSAFEA_PRODUCT_COUNT][STSAFEA_MAX_CMD_COUNT] = {
	...
	/* STSAFE_A120 */
	{
		...
		23,                        /* Generate MAC */
		23,                        /* Verify MAC */
		STSAFEA_EXEC_TIME_DEFAULT, /* Unwrap issuer envelope (Not
					      applicable)*/
...
const PLAT_UI16 stsafea_extended_cmd_timings[STSAFEA_PRODUCT_COUNT][STSAFEA_MAX_EXT_CMD_COUNT] = {
	/* STSAFE_A100 */
	{STSAFEA_EXEC_TIME_DEFAULT, /* start hash */
	 ...
	 STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT,
	 STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT,
	 STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT,
	 STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT,
	 STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT,
	 STSAFEA_EXEC_TIME_DEFAULT, STSAFEA_EXEC_TIME_DEFAULT},
	/* STSAFE_A110 */
	{STSAFEA_EXEC_TIME_DEFAULT, /* start hash */
	 STSAFEA_EXEC_TIME_DEFAULT, /* process hash */
	 STSAFEA_EXEC_TIME_DEFAULT, /* finish hash */
