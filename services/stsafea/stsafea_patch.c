...
stse_ReturnCode_t stsafe_get_patch_update_command_counter(stse_Handler_t *pSTSAFE,
...
stse_ReturnCode_t stsafe_patch_start(stse_Handler_t *pSTSAFE)
{
	(void)pSTSAFE;
	return STSE_SERVICE_INVALID_PARAMETER; /* TODO */
}

stse_ReturnCode_t stsafe_patch_update(stse_Handler_t *pSTSAFE)
{
	(void)pSTSAFE;
	return STSE_SERVICE_INVALID_PARAMETER; /* TODO */
}

stse_ReturnCode_t stsafe_patch_finalize(stse_Handler_t *pSTSAFE)
{
	(void)pSTSAFE;
	return STSE_SERVICE_INVALID_PARAMETER; /* TODO */
}
