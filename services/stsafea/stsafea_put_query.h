...
#define STSAFEA_SUBJECT_TAG_LOCAL_ENVELOPE_KEY_TABLE                                               \
	0x07                                      /*!< Local Envelope key table subject-tag */
#define STSAFEA_SUBJECT_TAG_LIFE_CYCLE_STATE 0x08 /*!< Life cycle state subject-tag */
#define STSAFEA_SUBJECT_TAG_PASSWORD_SLOT                                                          \
	0x09 /*!< Password slot subject-tag                                                        \
	      */
#define STSAFEA_SUBJECT_TAG_REMANING_CACHE_DERIVATION                                              \
	0x0C                                    /*!< Remaining cache deriation subject-tag */
...
#define STSAFEA_SUBJECT_TAG_DATA_PARTITION_CONFIGURATION                                           \
	0x12 /*!< data partition configuration subject-tag */
...
#define STSAFEA_SUBJECT_TAG_COMMAND_AUTHORIZATION_CONFIG                                           \
	0x24 /*!< Command authorisation configuration subject-tag */
#define STSAFEA_SUBJECT_TAG_COMMAND_ACCESS_CONDITION                                               \
	0x29 /*!< Command access condition subject-tag */
#define STSAFEA_SUBJECT_TAG_COMMAND_HOST_ENCRYPTION_FLAGS                                          \
	0x2A                                      /*!< Command Host encryption subject-tag */
...
#define STSAFEA_SUBJECT_TAG_PATCH_SIGNATURE_VERIFICATION_KEY                                       \
	0x43 /*!< Patch signature verification key subject-tag */
#define STSAFEA_SUBJECT_TAG_PATCH_SIGNATURE_CONFIGURATION_FLAGS                                    \
	0x44 /*!< Patch signature configuration flags subject-tag */
#define STSAFEA_SUBJECT_TAG_PATCH_UPDATE_COMMAND_COUNTER                                           \
	0x45 /*!< Patch update command counter subject-tag */
#define STSAFEA_SUBJECT_TAG_PATCH_PARENT_KEY_USAGE_LIMIT                                           \
	0x46                                      /*!< Patch Parent key usage limit subject-tag */
#define STSAFEA_SUBJECT_TAG_HOST_KEY_SLOT_V2 0x47 /*!< Host key slot v2 subject-tag */
#define STSAFEA_SUBJECT_TAG_GENERIC_PUBLIC_KEY_TABLE                                               \
	0x48 /*!< Generic public key table subject-tag */
#define STSAFEA_SUBJECT_TAG_HOST_KEY_SLOT_PROVISIONING_CONTROL_FIELDS                              \
	0x4A /*!< Host key slot provitioning control fields subject-tag */
#define STSAFEA_SUBJECT_TAG_SYMMETRIC_KEY_SLOT_PROVISIONING_CONTROL                                \
	0x4B /*!< Symmetric key slot provitioning control subject-tag */
#define STSAFEA_SUBJECT_TAG_GENERIC_PUBLIC_KEY_SLOT                                                \
	0x4C /*!< Generic public key slot subject-tag                                              \
	      */
#define STSAFEA_SUBJECT_TAG_GENERIC_PUBLIC_KEY_CONFIGURATION_FLAGS                                 \
	0x4D /*!< Generic public key configuration flags subject-tag */
...
typedef enum stsafea_life_cycle_state_t {
	...
	STSAFEA_LCS_OPERATIONAL_AND_LOCKED =
		0x83 /*!< STSAFEA in operational+lock life-cycle state */
} stsafea_life_cycle_state_t;

/**
 * \brief 		STSAFEA put life cycle service
 * \details 	This service format and send/receive the put life cycle
 * command/response \param[in] 	pSTSE 				Pointer to STSE
 * Handler \param[in] 	life_cycle_state 	Life cycle state \return
 * \ref STSE_OK on success ; \ref stse_ReturnCode_t error code otherwise
 */
stse_ReturnCode_t stsafea_put_life_cyle_state(stse_Handler_t *pSTSE,
 ...
 * \details 	This service format and send/receive the put life cycle
 * command/response \param[in] 	pSTSE	 			Pointer to STSE
 * Handler \param[out] 	pLife_cycle_state 	Life cycle state \return
 * \ref STSE_OK on success ; \ref stse_ReturnCode_t error code otherwise
 */
stse_ReturnCode_t stsafea_query_life_cycle_state(stse_Handler_t *pSTSE,
