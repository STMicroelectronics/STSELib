	...
	stse_Handler_t *pSTSE, stsafea_host_key_provisioning_ctrl_fields_t *pCtrl_fields)
{
	...
	stse_frame_element_allocate_push(&RspFrame, eCtrl_fields,
					 sizeof(stsafea_host_key_provisioning_ctrl_fields_t),
	...
	stse_Handler_t *pSTSE, stsafea_host_key_provisioning_ctrl_fields_t *pCtrl_fields)
{
	...
	stse_frame_element_allocate_push(&CmdFrame, eCmd_header, STSAFEA_HEADER_SIZE, &cmd_header);
	stse_frame_element_allocate_push(&CmdFrame, eSubject_tag, 1, &subject_tag);
	stse_frame_element_allocate_push(&CmdFrame, eCtrl_fields,
					 sizeof(stsafea_host_key_provisioning_ctrl_fields_t),
					 (PLAT_UI8 *)pCtrl_fields);
					    ...
					    stsafea_host_key_slot_v2_t *pHost_key_slot_v2)
{
	...
	stse_frame_allocate(RspFrame);
	stse_frame_element_allocate_push(&RspFrame, eRsp_header, STSAFEA_HEADER_SIZE, &rsp_header);
	stse_frame_element_allocate_push(&RspFrame, eHost_key_slot,
					 sizeof(stsafea_host_key_slot_v2_t),
						 ...
						 stsafea_aes_128_host_keys_t *host_keys)
{
	...
	stse_frame_element_allocate_push(&CmdFrame, eCmd_header, STSAFEA_HEADER_SIZE, &cmd_header);
	stse_frame_element_allocate_push(&CmdFrame, eSubject_tag, 1, &subject_tag);
	stse_frame_element_allocate_push(&CmdFrame, eHost_keys, sizeof(stsafea_aes_128_host_keys_t),
					 (PLAT_UI8 *)host_keys);
						...
						stsafea_host_keys_t *host_keys)
{
	...
	PLAT_UI8 host_keys_length =
		(key_type == STSAFEA_AES_128_HOST_KEY ? STSAFEA_HOST_AES_128_KEYS_SIZE
	...
	stse_frame_element_allocate_push(&CmdFrame, eHost_keys, host_keys_length,
					 (PLAT_UI8 *)host_keys);
							...
							PLAT_UI8 *pHost_key_envelope)
{
	...
	stse_frame_element_allocate_push(&CmdFrame, eExt_cmd_header, STSAFEA_HEADER_SIZE,
					 &ext_cmd_header);
	stse_frame_element_allocate_push(&CmdFrame, eHost_keys, host_keys_envelope_length,
					 (PLAT_UI8 *)pHost_key_envelope);
					     ...
					     stsafea_host_key_type_t host_keys_type)
{
	...
	stse_frame_element_allocate_push(&CmdFrame, eHost_keys_type, 1,
					 (PLAT_UI8 *)&host_keys_type);
	...
	PLAT_UI8 *pSignature)
{
	...
	stse_frame_element_allocate_push(&CmdFrame, eSignature_public_key_slot, 1,
					 &signature_public_key_slot);
