...
#define STSAFEA_HASH_ALGO_ID_SIZE                                                                  \
	(STSAFEA_HASH_ALGO_ID_LENGTH_SIZE + STSAFEA_HASH_ALGO_ID_VALUE_SIZE)
 ...
 * Pointer to target SE handler \param[in] 		sha_algorithm \ref
 * stse_hash_algorithm_t SHA algorithm
 ...
 * \details 		This service format and send/receive STSAFE-Axxx process
 * hash command/response \param[in]		pSTSE
 * Pointer to target SE handler \param[in] 		pMessage
 ...
 * \brief 			STSAFEA start hash service
 * \details 		This service format and send/receive STSAFE-Axxx process
 * hash command/response \param[in]       pSTSE			Pointer to
 * target SE handler
