...
/*! STSAFE-A AES key information structure for derive key command output key description information.
 *  Doesn't contain slot number */
...
/**
  ...
  * | :--- | :---: | :---: | :--- |
  * | **Extract-only** | 1 | 0 | Derives a Pseudo-Random Key (PRK) from IKM + Salt.
  * The PRK is stored in an internal slot. |
