					      ...
					      stsafea_life_cycle_state_t life_cycle_state)
{
	...
	stse_frame_element_allocate_push(&CmdFrame, eLifeCycleState, 1,
					 (PLAT_UI8 *)&life_cycle_state);
						 ...
						 stsafea_life_cycle_state_t *pLife_cycle_state)
{
	...
	stse_frame_allocate(RspFrame);
	stse_frame_element_allocate_push(&RspFrame, eRsp_header, 1, &rsp_header);
	stse_frame_element_allocate_push(&RspFrame, eLife_cycle_state, 1,
					 (PLAT_UI8 *)pLife_cycle_state);
