...
typedef enum stsafea_cmd_code_t {
	...
	STSAFEA_CMD_UNWRAP_ISSUER_ENVELOPE, /*!< STSAFEA Unwrap issuer envelope
					       command code*/
	STSAFEA_CMD_DELETE,                 /*!< STSAFEA Delete MAC command code*/
	STSAFEA_CMD_HIBERNATE,              /*!< STSAFEA Hibernate command code*/
	STSAFEA_CMD_WRAP_LOCAL_ENVELOPE,    /*!< STSAFEA Wrap Local Envelope command
					       code*/
	STSAFEA_CMD_UNWRAP_LOCAL_ENVELOPE,  /*!< STSAFEA Unwrap Local Envelope command
					       code*/
...
typedef enum stsafea_extended_cmd_code_t {
	...
	STSAFEA_EXTENDED_CMD_PROCESS_HASH,       /*!< STSAFE-A Process hash extended command
						    code */
	STSAFEA_EXTENDED_CMD_FINISH_HASH,        /*!< STSAFE-A Finish hash extended command
						    code */
	STSAFEA_EXTENDED_CMD_START_VOLATILE_KEK_SESSION,  /*!< STSAFE-A Start volatile
							     KEK extended command code
							   */
	STSAFEA_EXTENDED_CMD_ESTABLISH_SYMMETRIC_KEYS,    /*!< STSAFE-A Establish
							     symmetric keys extended
							     command code */
	STSAFEA_EXTENDED_CMD_CONFIRM_SYMMETRIC_KEYS,      /*!< STSAFE-A confirm symmetric
							     keys extended command code */
	STSAFEA_EXTENDED_CMD_STOP_VOLATILE_KEK_SESSION,   /*!< STSAFE-A Stop volatile
							     KEK extended command code
							   */
	STSAFEA_EXTENDED_CMD_WRITE_HOST_KEY_V2_PLAINTEXT, /*!< STSAFE-A Plaintext
							     write host key v2
							     extended command code */
	STSAFEA_EXTENDED_CMD_WRITE_HOST_KEY_V2_WRAPPED,   /*!< STSAFE-A Wrapped write
							     host key v2 extended
							     command code */
	STSAFEA_EXTENDED_CMD_WRITE_SYMMETRIC_KEY_WRAPPED, /*!< STSAFE-A Write
							     symmetric key extended
							     command code */
	STSAFEA_EXTENDED_CMD_WRITE_PUBLIC_KEY,            /*!< STSAFE-A Write public key extended
							     command code */
	STSAFEA_EXTENDED_CMD_GENERATE_ECDHE,              /*!< STSAFE-A Generate ECDHE extended
							     command code */
	STSAFEA_EXTENDED_CMD_GENERATE_CHALLENGE =
		14, /*!< STSAFE-A Generate challenge command code */
	STSAFEA_EXTENDED_CMD_VERIFY_ENTITY_SIGNATURE, /*!< STSAFE-A Verify entity
							 signature command code */
	...
	STSAFEA_EXTENDED_CMD_START_ENCRYPT,           /*!< STSAFE-A Start encrypt command code
						       */
	STSAFEA_EXTENDED_CMD_PROCESS_ENCRYPT,         /*!< STSAFE-A Process encrypt command
							 code */
	...
	STSAFEA_EXTENDED_CMD_START_DECRYPT,           /*!< STSAFE-A Start decrypt command code
						       */
	STSAFEA_EXTENDED_CMD_PROCESS_DECRYPT,         /*!< STSAFE-A Process decrypt command
							 code */
	STSAFEA_EXTENDED_CMD_FINISH_DECRYPT,          /*!< STSAFE-A Finish decrypt command code
						       */
	STSAFEA_EXTENDED_CMD_WRITE_SYMMETRIC_KEY_PLAINTEXT, /*!< STSAFE-A Write
							       symmetric key paintext
							       command code */
	STSAFEA_EXTENDED_CMD_ESTABLISH_HOST_KEY_V2,         /*!< STSAFE-A Establish host key
							       V2 command code */
	STSAFEA_EXTENDED_CMD_ERASE_SYMMETRIC_KEY_SLOT,      /*!< STSAFE-A Erase symmetric
							       key slot command code */
	STSAFEA_EXTENDED_CMD_DECOMPRESS_PUBLIC_KEY          /*!< STSAFE-A Decompress command
							       code */
...
stse_ReturnCode_t stsafea_get_command_AC_table(stse_Handler_t *pSTSE, PLAT_UI8 total_command_count,
...
void stsafea_perso_info_get_cmd_encrypt_flag(stse_perso_info_t *pPerso, PLAT_UI8 command_code,
					     PLAT_UI8 *pEnc_flag);

void stsafea_perso_info_get_rsp_encrypt_flag(stse_perso_info_t *pPerso, PLAT_UI8 command_code,
					     PLAT_UI8 *pEnc_flag);

void stsafea_perso_info_get_ext_cmd_encrypt_flag(stse_perso_info_t *pPerso, PLAT_UI8 command_code,
						 PLAT_UI8 *pEnc_flag);

void stsafea_perso_info_get_ext_rsp_encrypt_flag(stse_perso_info_t *pPerso, PLAT_UI8 command_code,
						 PLAT_UI8 *pEnc_flag);
...
void stsafea_perso_info_set_cmd_encrypt_flag(stse_perso_info_t *pPerso, PLAT_UI8 command_code,
					     PLAT_UI8 enc_flag);

void stsafea_perso_info_set_rsp_encrypt_flag(stse_perso_info_t *pPerso, PLAT_UI8 command_code,
					     PLAT_UI8 enc_flag);

void stsafea_perso_info_set_ext_cmd_encrypt_flag(stse_perso_info_t *pPerso, PLAT_UI8 command_code,
						 PLAT_UI8 enc_flag);

void stsafea_perso_info_set_ext_rsp_encrypt_flag(stse_perso_info_t *pPerso, PLAT_UI8 command_code,
						 PLAT_UI8 enc_flag);
