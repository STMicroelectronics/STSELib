...
stse_ac_change_right_t new_read_ac_change_right : STSE_1BIT_LEN;     /*!< \brief New read access
                                                                           condition change right */
stse_zone_ac_change_indicator_t change_ac_indicator : STSE_1BIT_LEN; /*!< \brief Change access
                                                                           condition indicator */
...
/**
  ...
  * \param[in]   pData                Pointer to the new associated data buffer
  *                                   (data to be written along with counter decrement
  *                                   in the zone)
