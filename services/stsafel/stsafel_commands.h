...
typedef enum stsafel_cmd_code_t {
	...
	STSAFEL_CMD_GET_DATA,     /*!< STSAFE-L010 general purpose "Get data" command code
				   */
	STSAFEL_CMD_GET_PUBLIC_KEY_CERTIFICATE, /*!< STSAFE-L010 general purpose "Get
						   Public key certificate" command
						   code */
	STSAFEL_CMD_DECREMENT,                  /*!< STSAFE-L010 data partition "Decrement" command
						   code */
	...
	STSAFEL_CMD_GENERATE_SIGNATURE =
		0x11U,                 /*!< STSAFE-L010 "Generate Signature" command code */
