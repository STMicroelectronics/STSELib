...
#define STSAFEL_EXEC_TIME_DEFAULT                                                                  \
	500U /*!< STSAFE-L default command processing time (used when specific time                \
		== 0) */
 ...
 */
PLAT_UI16 stsafel_cmd_exec_duration(stse_Handler_t *pSTSE, stsafel_cmd_code_t command_code);
