...
const PLAT_UI16 stsafel_cmd_timings[STSAFEL_PRODUCT_COUNT][STSAFEL_MAX_CMD_COUNT] = {
	/* STSAFE_L010 */
	{
		STSAFEL_EXEC_TIME_DEFAULT, /*!< STSAFE-L general purpose "Echo"
					      command code */
		STSAFEL_EXEC_TIME_DEFAULT, /*!< STSAFE-L general purpose "Reset"
					      command code */
		STSAFEL_EXEC_TIME_DEFAULT, /*!< STSAFE-L general purpose "Hibernate"
					      command code */
		STSAFEL_EXEC_TIME_DEFAULT, /*!< STSAFE-L general purpose "Get data"
					      command code */
		STSAFEL_EXEC_TIME_DEFAULT, /*!< STSAFE-L general purpose "Get Public
					      key certificate" command code */
		STSAFEL_EXEC_TIME_DEFAULT, /*!< STSAFE-L data partition "Decrement"
					      command code */
		STSAFEL_EXEC_TIME_DEFAULT, /*!< STSAFE-L data partition "Read"
					      command code */
		STSAFEL_EXEC_TIME_DEFAULT, /*!< STSAFE-L data partition "Update"
					      command code */
		STSAFEL_EXEC_TIME_DEFAULT, /*!< STSAFE-L "Generate Signature"
					      command code */
...
inline PLAT_UI16 stsafel_cmd_exec_duration(stse_Handler_t *pSTSE, stsafel_cmd_code_t command_code)
{
	...
	return stsafel_cmd_timings[pSTSE->device_type - STSE_DEVICE_STSAFEL_FAMILY_INDEX]
				  [CommandCode];
}
