...
stse_ReturnCode_t stsafel_frame_raw_transfer(stse_Handler_t *pSTSE, stse_frame_t *pCmdFrame,
...
stse_ReturnCode_t stsafel_frame_transfer(stse_Handler_t *pSTSE, stse_frame_t *pCmdFrame,
					 stse_frame_t *pRspFrame)
{
	...
	/*- Perform Transfer*/
	ret = stsafel_frame_raw_transfer(pSTSE, pCmdFrame, pRspFrame, inter_frame_delay);
